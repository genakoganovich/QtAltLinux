...
QT_MOC_LITERAL(1, 17, 11), // "iconPressed"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 15), // "slotTextChanged"
QT_MOC_LITERAL(4, 46, 5) // "pText"

    },
    "IconizedLineEdit\0iconPressed\0\0"
    "slotTextChanged\0pText"
};
...
void IconizedLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (IconizedLineEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IconizedLineEdit::iconPressed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject IconizedLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_meta_stringdata_IconizedLineEdit.data,
    qt_meta_data_IconizedLineEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void IconizedLineEdit::iconPressed()
{
